...
public class FindPaths {
	public static void main(String[] args) {
		...
		while(true) {
			...
			Path myPath = g.shortestPath(a, b);
			System.out.println("Shortest path from " + a.toString() +
			        " to " + b.toString() + ":");
			if (myPath != null) {
			    String resultingPathStr = "";
			    for (Vertex vertexItem : myPath.vertices) {
			        resultingPathStr += vertexItem.toString() + " ";
			    }
			    System.out.println(resultingPathStr);
			    System.out.println(myPath.cost);
			} else {
